...
import provided.util.DaoBase;
	...
	// JDBC to Perform CRUD (SQL) operations for TABLES
...
private List<Material> fetchMaterialsForProject(Connection conn, Integer projectId)
	...
	// W10 New Additional Methods/Exceptions from  fetchAllProjects Projects service class 
...
// wk 11  Project Service method created modify projects details;
public boolean modifyProjectDetails(Project project) {
    ...
    String sql = ""
        ...
        + "WHERE project_id = ?";
    // @formatter:on
    // wk 11 2-4. Test connections for Update throws DbExceptions
    try(Connection conn = DbConnections.getConnection()) {
        startTransaction(conn);
